...
class DiscordXp {
  ...
  */
  ...
  static async setURL(dbUrl: string) {
    if (!dbUrl) throw new TypeError("A database url was not provided.");
    mongoUrl = dbUrl;
    return connect(dbUrl +"useNewUrlParser=true&useUnifiedTopology=true&useFindAndModify=false");
  }
  ...
  */
  ...
  static async createUser(userId: any, guildId: any) {
    ...
    await newUser.save().catch((e: any) => console.log(`Failed to create user: ${e}`));
  ...
  */
  ...
  static async appendXp(userId: string, guildId: string, xp: number) {
    ...
    if (!user) {
      ...
      await newUser.save().catch((e: any) => console.log(`Failed to save new user.`));
    ...
    await user.save().catch((e: any) => console.log(`Failed to append xp: ${e}`) );
  ...
  */
  ...
  static async appendLevel(userId: any, guildId: any, levelss: string) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    ...
    user.save().catch((e: any) => console.log(`Failed to append level: ${e}`) );
  ...
  */
  ...
  static async setXp(userId: any, guildId: any, xp: number) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (xp !== 0 && !xp) throw new TypeError("An amount of xp was not provided.");
    ...
    user.save().catch((e: any) => console.log(`Failed to set xp: ${e}`) );
  ...
  */
  ...
  static async setLevel(userId: any, guildId: any, level: number) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    ...
    user.save().catch((e: any) => console.log(`Failed to set level: ${e}`) );
  ...
  */
  ...
  static async fetch(userId: string, guildId: string, fetchPosition = false) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
  ...
  */
  ...
  static async subtractXp(userId: any, guildId: any, xp: number) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (xp !== 0 && !xp) throw new TypeError("An amount of xp was not provided.");
    ...
    user.save().catch((e: any) => console.log(`Failed to subtract xp: ${e}`) );
  ...
  */
  ...
  static async subtractLevel(userId: any, guildId: any, levelss: number) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (!levelss) throw new TypeError("An amount of levels was not provided.");
    ...
    user.save().catch((e: any) => console.log(`Failed to subtract levels: ${e}`) );
  ...
  */
  ...
  static async fetchLeaderboard(guildId: any, limit: number) {
    if (!guildId) throw new TypeError("A guild id was not provided.");
  ...
  */
  ...
  static async computeLeaderboard(client: Client, leaderboard: any[], fetchUsers = false) {
    ...
    if (fetchUsers) {
      for (const key of leaderboard) {
        ...
        computedArray.push({
          ...
          xp: key.xp,
          level: key.level,
          position: (leaderboard.findIndex((i: { guildID: any; userID: any; }) => i.guildID === key.guildID && i.userID === key.userID) + 1),
          username: user.username,
          discriminator: user.discriminator
        });
      }
    } else {
      leaderboard.map((key: { guildID: any; userID: any; xp: any; level: any; }) => computedArray.push({
        guildID: key.guildID,
        userID: key.userID,
        xp: key.xp,
        level: key.level,
